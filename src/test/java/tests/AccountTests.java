...
public class AccountTests extends BaseTest {
    ...
    @Test(priority = 7,description = "(ZT_002)Creating Account Without Mandatory Fields and Save")
    ...
    @Test(priority = 8,description = "(ZT_002)Creating Account Without Mandatory Fields and Save&new")
    ...
    @Test(priority = 9,description = "(ZT_002)Creating Account Without Mandatory Fields and Cancel")
    ...
    public void EditCreatedAccount() throws InterruptedException {
        AccountPage accountPage = new AccountPage(driver);
        accountPage.VerifyUserCanEdit("chandini");
    }
    ...
    public void EditCreatedAccountandCancel() throws InterruptedException {
        AccountPage accountPage = new AccountPage(driver);
        accountPage.VerfiyUserCancelAfterEditing("chandini");
    }
